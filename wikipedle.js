...
function getArticleOfTheDay(puzzleNumber){
    var wordArray = ['Dragon', 'Dragon', 'Dragon', 'Democracy', 'Geometry', 'Spain' ,'Hacker', 'Whale', 'Pythagoras', 'Ultraviolet', 'Ultraviolet', 'Ultraviolet', 'Ultraviolet', 'Ultraviolet' ,'Ultraviolet', 'Ultraviolet','Carbohydrate', 'Surveillance', 'Phishing', 'Terrorism',  'Pine'];
