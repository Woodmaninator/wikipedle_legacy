...
function getArticleOfTheDay(puzzleNumber){
    var wordArray = ['Bacteria', 'Gravity', 'Bone', 'Lute', 'Prison', 'Sheep', 'Antarctica', 'Capacitor', 'Planetarium', 'Nile', 'Triceratops', 'Earthquake', 'Nitrogen', 'Cheese', 'Neutron', 'Greenland', 'Shark', 'Volcano', 'Graphite', 'Thor', 'Strawberry', 'Neuron', 'Sphinx', 'Testosterone', 'Laser', 'Glucose', 'Andes', 'Diabetes', 'Wasp', 'Engine', 'Library', 'Momentum', 'Wheel', 'DVD', 'Pendulum', 'Lynx', 'Mosque' , 'Friction'];
